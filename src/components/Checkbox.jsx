  ...
  return (
    <div className={clsx('flex items-start', className)}>
      <input
        ...
        disabled={disabled}
        className={clsx(
          'rounded border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 transition-colors focus:ring-2 focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-gray-900 disabled:opacity-50 disabled:cursor-not-allowed',
          sizes[size],
          colors[color]
        )}
        {...props}
